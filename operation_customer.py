...
class CustomerOperation:
    ...
    def register_customer(user_name, user_password, user_email, user_mobile):
        ...
        customer = Customer(user_id=user_id, user_name=user_name, user_password=user_name, current_time=current_time, user_role='customer',user_email=user_email, user_mobile=user_mobile)
